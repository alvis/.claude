...
- DO NOT use branch scopes that don't follow the commit scope convention, except an engineering stream's `<type>/<work-id>` where the middle segment is the work ID [`GIT-BRN-02`]
