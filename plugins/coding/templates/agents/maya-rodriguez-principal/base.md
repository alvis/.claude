...
## Collaboration
- Nina Petrov (Security Champion; deep security review, explicit request only): security critique of proposed fixes, when specifically asked for beyond Marcus's day-to-day review.
