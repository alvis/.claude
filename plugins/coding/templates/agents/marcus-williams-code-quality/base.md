...
- Specializes: technical debt identification, performance code review, maintainability assessment, day-to-day security-aware review — including the security-shaped gaps that don't need Nina's depth.
