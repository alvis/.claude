...
- Generated output can lower the LOC zone, but never the file-count zone. The Risk section remains required whenever either authored LOC or all-path file count places the PR in yellow.
