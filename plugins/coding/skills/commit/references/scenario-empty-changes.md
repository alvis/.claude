...
- If the abandoned change had a downstream bookmark, the bookmark moved to the parent automatically; run `restack.sh` if it now points to merged-on-origin (would re-route to [workflow-correct-merged.md](./workflow-correct-merged.md)).
