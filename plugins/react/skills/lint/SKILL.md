---
name: lint
description: Use when React JSX, components, hooks, accessibility, project structure, tests, or Storybook files need mechanical standards enforcement.
model: opus
...
Forward the request exactly once through `Skill(coding:lint *)` using `$ARGUMENTS --profile="${CLAUDE_SKILL_DIR}/profile.md"`.
