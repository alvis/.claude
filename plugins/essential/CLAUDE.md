...
- **Expose uncertainty.** Distinguish user-stated intent, observed repository facts, inferences, accepted assumptions, and unresolved questions. Never present a hypothesis as territory evidence.
- **Let territory revise the map.** When evidence invalidates a plan, stop following the stale portion. Reassess the affected scope and dependencies, then take only a reversible low-impact path and record it or escalate the material decision.
