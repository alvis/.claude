...
- **Route ongoing delegation through the main agent.** A nested agent that needs another agent for continuing work asks the main agent for a suitable `agent_id`; the main agent reuses the best warm match by prior folder or feature history, or spawns a new named teammate when none fits.
