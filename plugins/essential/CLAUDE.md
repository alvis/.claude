...
- **Route to the live roster.** Inspect the available agents immediately before every spawn and match by outcome, tools, and independence. Treat named routing rows as proven defaults, not limits, and never invent an unavailable agent.
