...
Request the subagent to perform the following workflow creation:
    ...
    **Workflow Specifications**:
    ...
    - **Target Location**: constitutions/workflows/[category]/[workflow-name].md
    ...
    **Steps**
    ...
    4. **Update Documentation Indexes**:
       - Update constitutions/workflows/README.md with new workflow entry
    ...
    **[IMPORTANT]** You MUST return the following execution report (<1000 tokens):
    ...
    outputs:
      workflow_file_path: 'constitutions/workflows/[category]/[workflow-name].md'
...
status: completed
outputs:
  workflow_file: 'constitutions/workflows/[category]/[workflow-name].md'
  implementation_summary: 'Brief description of workflow implementation approach'
  creation_report:
